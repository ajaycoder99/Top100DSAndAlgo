...
public class Q13IntersectionOfLinkedList {
    ...
    public static void main(String[] args) {
        Q13IntersectionOfLinkedList list1 = new Q13IntersectionOfLinkedList();
        ...
        Q13IntersectionOfLinkedList list2 = new Q13IntersectionOfLinkedList();
        ...
        Node reversed = list1.reverseLinkedListInPairItr(head1);
        list1.printLinkedList(reversed);
    }
}
